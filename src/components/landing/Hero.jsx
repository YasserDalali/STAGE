...
function Hero() {
    return (
        <div className="relative overflow-hidden bg-white text-white min-h-[90vh] flex items-center">
            <div className="absolute rounded-3xl mx-20 inset-0 bg-gradient-to-br from-primary to-secondary opacity-100 animate-[fadeIn_2s_ease-in_forwards]" />

            <div className="relative w-full">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
                    <div className="text-center">
                        <div className="max-w-3xl mx-auto space-y-8 opacity-0 animate-[slideInDown_1s_ease-out_0.5s_forwards]">
                            <h1 className="text-4xl md:text-6xl lg:text-9xl font-bold text-center">
                                Requests Made Easy
                            </h1>
                            ...
                            <div className="flex justify-center opacity-0 animate-[slideInUp_1s_ease-out_1s_forwards]">
                                <Button
                                    icon={
